        ...
        <nav id="navbarCollapse" class="absolute right-4 top-full hidden w-full max-w-[250px] rounded-lg bg-white py-5 shadow-lg lg:static lg:block lg:bg-transparent lg:py-0 lg:px-4 lg:shadow-none xl:px-6">
          <ul class="blcok lg:flex">
            <li class="group relative">
              <a href="<?= BASE_URL?>" class="ud-menu-scroll flex py-2 text-base text-dark lg:inline-flex lg:group-hover:opacity-70"> Home </a>
            </li>
            <li class="group relative">
              <a href="<?= BASE_URL?>/#about" class="ud-menu-scroll flex py-2 text-base text-dark lg:inline-flex lg:px-4 lg:group-hover:opacity-70 xl:ml-12"> About </a>
            </li>
            <li class="group relative">
              <a href="<?= BASE_URL?>/#pricing" class="ud-menu-scroll flex py-2 text-base text-dark lg:inline-flex lg:px-4 lg:group-hover:opacity-70 xl:ml-12"> Pricing </a>
            </li>
          </ul>
        </nav>
